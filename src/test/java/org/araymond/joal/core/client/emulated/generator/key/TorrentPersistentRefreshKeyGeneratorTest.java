...
public class TorrentPersistentRefreshKeyGeneratorTest {
    ...
    public void shouldHaveOneKeyPerTorrent() {
        final KeyGenerator generator = new TorrentVolatileRefreshKeyGenerator(8, KeyTypes.HASH, false, false);
    ...
    public void shouldNotRefreshKeyWhenTorrentHasStopped() {
        final KeyGenerator generator = new TorrentPersistentRefreshKeyGenerator(8, KeyTypes.HASH, false, false);
    ...
    public void shouldConsiderEntryEvictableIfOlderThanOneHourAndAHalf() {
        final TorrentPersistentRefreshKeyGenerator generator = new TorrentPersistentRefreshKeyGenerator(8, KeyTypes.HASH, false, false);
