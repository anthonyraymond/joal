...
public class TorrentPersistentRefreshKeyGeneratorTest {
    ...
    public void shouldNotRefreshKeyWhenTorrentHasStopped() {
        final KeyGenerator generator = new TorrentPersistentRefreshKeyGenerator(8, KeyTypes.HASH, Casing.NONE);
    ...
    public void shouldConsiderEntryEvictableIfOlderThanOneHourAndAHalf() {
        final TorrentPersistentRefreshKeyGenerator generator = new TorrentPersistentRefreshKeyGenerator(8, KeyTypes.HASH, Casing.NONE);
