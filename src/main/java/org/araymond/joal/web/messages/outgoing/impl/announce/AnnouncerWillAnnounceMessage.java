 ...
 */
public class AnnouncerWillAnnounceMessage extends OutgoingMessage {

    private final MockedTorrent torrent;

    protected AnnouncerWillAnnounceMessage(final MockedTorrent torrent) {
        super(OutgoingMessageTypes.ANNOUNCER_WILL_ANNOUNCE);
